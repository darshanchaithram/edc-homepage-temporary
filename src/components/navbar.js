          ...
          <div className="navbar-middle">
            ...
            <Link to="/" className="navbar-navlink">
              <img
                alt={props.image_alt}
                src={props.image_src}
                className="navbar-image navbar-logo-title"
              />
            </Link>
        ...
        <div data-role="MobileMenu" className="navbar-mobile-menu">
          <div className="navbar-nav">
            <div className="navbar-container1">
              <span className="navbar-logo-center">
            ...
            <div className="navbar-middle1">
              <span className="navbar-text08">{props.text6}</span>
              <span className="navbar-text09">{props.text7}</span>
