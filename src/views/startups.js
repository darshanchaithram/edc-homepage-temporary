          ...
          <div className="startups-navbar1">
            ...
            <div className="startups-middle">
              ...
              <div className="startups-right">
                <Link to="/" className="startups-text03 navbar-link">
                  EVENTS
                </Link>
          ...
          <div data-role="MobileMenu" className="startups-mobile-menu">
            <div className="startups-nav">
              <div className="startups-container2">
                <span className="startups-logo-center">
              ...
              <div className="startups-middle1">
                <span className="startups-text08">ABOUT</span>
                <span className="startups-text09">STARTUPS</span>
                <span className="startups-text10">
                  <span>OUR TEAM</span>
                  <br></br>
                </span>
                <span className="startups-text13">EVENTS</span>
                <span className="startups-text14">TINKERHUB</span>
                <span className="startups-text15">CONTACT</span>
              </div>
      ...
      <div className="startups-hero">
        <div className="startups-container3">
          ...
          <h2 className="startups-text21">
            <span>We have 30+ startups incubated within our premises</span>
            <br></br>
          </h2>
        </div>
      </div>
      <div className="startups-blog">
        <BlogPostCard1 rootClassName="blog-post-card1-root-class-name5"></BlogPostCard1>
        <BlogPostCard2 rootClassName="blog-post-card2-root-class-name"></BlogPostCard2>
        <BlogPostCard2 rootClassName="blog-post-card2-root-class-name1"></BlogPostCard2>
      </div>
    </div>
  )
}
